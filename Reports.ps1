...
$out | Select-Object  Name, Status, NextRuNTime, LastRunTime, LastRunResult, Author, Created | ConvertTo-Html >C:\Test\task-sceduler.html
...
$Outputreport += "</table></BODY></HTML>"
$Outputreport | out-file C:\Users\ramanjaneyulub\Desktop\CitizensParking\Reports\Windows_Server_Health_Status.html 
